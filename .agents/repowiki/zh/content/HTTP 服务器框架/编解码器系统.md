...
## 更新摘要
**所做更改**
- 标准化了文档中所有文件路径和行号的引用格式，统一使用 `[filename:start-end](file://path/to/file#Lstart-Lend)` 格式
- 更新了 WebSocket 流式系统章节的行号引用，确保与当前代码结构一致
- 修正了部分图表来源的行号引用，使其更准确地反映实际代码位置
- 保持了文档的整体结构和内容不变，仅优化了引用格式的规范性
...
- [ws/stream.go:223-255](file://ws/stream.go#L223-255)
...
- [example/websocket/client/main.go:19-207](file://example/websocket/client/main.go#L19-L207)
