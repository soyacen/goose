...
A[otelhttp] --> B[HTTP 服务器追踪]
A --> C[HTTP 客户端追踪]
D[otel/trace] --> E[追踪 API]
...
| 组件 | 版本 | 用途 |
|------|------|------|
| otelhttp | v0.60.0 | HTTP 请求追踪 |
| otel | v1.38.0 | 核心追踪 API |
| otel/trace | v1.38.0 | 追踪上下文管理 |
...
| 选项 | 类型 | 描述 | 默认值 |
|------|------|------|--------|
| 采样率 | float64 | 追踪采样比例 | 1.0 |
| 批量大小 | int | 导出批次大小 | 100 |
| 导出间隔 | duration | 导出时间间隔 | 5s |
| 超时时间 | duration | 导出超时设置 | 30s |
