...
## 简介
本文件系统性阐述 Goose 的 Protocol Buffers 代码生成体系，重点围绕 protoc 插件的工作原理与使用方法展开。内容覆盖：
...
- HTTP 注解缺失：未提供 google.api.http 选项时，默认使用 POST 且 body 为 “*”，路径为 “/<服务全名>/<方法名>”。
...
- 生成结果
  ...
  - 服务器/客户端编解码器：针对 HttpBody 与 HttpRequest 的特殊处理
