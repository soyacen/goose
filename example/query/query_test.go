...
func TestBoolPath(t *testing.T) {
	...
	cli := NewBoolQueryHttpClient("http://localhost:28081")
...
func TestInt32Path(t *testing.T) {
	...
	defer server.Close()
	time.Sleep(time.Second)
	cli := NewInt32QueryHttpClient("http://localhost:28082")
...
func TestInt64Path(t *testing.T) {
	...
	defer server.Close()
	time.Sleep(time.Second)
	cli := NewInt64QueryHttpClient("http://localhost:28083")
...
func TestUint32Path(t *testing.T) {
	...
	defer server.Close()
	time.Sleep(time.Second)
	cli := NewUint32QueryHttpClient("http://localhost:28084")
...
func TestUint64Path(t *testing.T) {
	...
	defer server.Close()
	time.Sleep(time.Second)
	cli := NewUint64QueryHttpClient("http://localhost:28085")
...
func TestFloatPath(t *testing.T) {
	...
	defer server.Close()
	time.Sleep(time.Second)
	cli := NewFloatQueryHttpClient("http://localhost:28086")
...
func TestDoublePath(t *testing.T) {
	...
	defer server.Close()
	time.Sleep(time.Second)
	cli := NewDoubleQueryHttpClient("http://localhost:28087")
...
func TestStringPath(t *testing.T) {
	...
	defer server.Close()
	time.Sleep(time.Second)
	cli := NewStringQueryHttpClient("http://localhost:28088")
...
func TestEnumPath(t *testing.T) {
	...
	defer server.Close()
	time.Sleep(time.Second)
	cli := NewEnumQueryHttpClient("http://localhost:28089")
